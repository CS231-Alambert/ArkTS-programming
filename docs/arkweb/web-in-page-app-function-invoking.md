...
[JavaScriptProxy.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-7.0-beta-20260514/ArkWeb/UseFrontendJSApp/entry2/src/main/ets/pages/JavaScriptProxy.ets#L16-L71)
...
* 示例1：
  ...
  [RegisterJavaScriptProxyOne.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-7.0-beta-20260514/ArkWeb/UseFrontendJSApp/entry2/src/main/ets/pages/RegisterJavaScriptProxyOne.ets#L16-L73)
* 示例2：
  ...
  [RegisterJavaScriptProxyTwo.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-7.0-beta-20260514/ArkWeb/UseFrontendJSApp/entry2/src/main/ets/pages/RegisterJavaScriptProxyTwo.ets#L16-L78)
...
2. 举例说明通道是否建立成功。
   ...
   使用[复杂类型使用方法](web-in-page-app-function-invoking.md)中应用侧和前端页面之间传递Array作为示例，调试结果如下图所示：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/MIOHhNoRTNKUcUpCZpG2jg/zh-cn_image_0000002626228752.png?HW-CC-KV=V1&HW-CC-Date=20260618T042952Z&HW-CC-Expire=86400&HW-CC-Sign=DEE2357CD950AA41B9EC0B1AE222A5B0E5885030C0D9F8730EF31EAC9490AA7E)